...
<body class="bg-dark">
  ...
  <div class="jumbotron d-flex justify-content-center">
      ...
      <div class="buttons">
        ...
        <a href="Python.php" class="btn btn-outline-primary mx-2 my-1">Python</a>
        <a href="Drive.php" class="btn btn-primary mx-2 my-1">Drive links</a>
      </div>
...
<?php
          ...
          if(isset($_POST['btnd']) and $_POST['btnd'] == "Add Link")
          {
            ...
            $l = $_POST['link_f'];
            $sql = "insert into drive values ('$title','$de','$l');";
          ...
          {
              $l = $_POST['del_link_f'];
              $sql = "delete from drive where link = '$l'";
              mysqli_query($con,$sql);
          }
    ?>
